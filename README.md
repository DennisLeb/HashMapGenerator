...
* Aus einer beschränken Anzahl von Beispielnamen setzen sich die vollen Namen der generierten Nutzer zusammen
...
#### Korrekte Eingabe:
<img width="700" height="286" alt="Screenshot 5" src="https://github.com/user-attachments/assets/9f3e91a7-defa-4fe4-9ca6-69a5344deeb2" />
...
* Es könnte wohl dazu kommen, dass zwei Usernames tatsächlich identisch sind. Hoffen wir einfach mal, dass die Wahrscheinlichkeit davon so gering ist wie ich denke

#### Sonstiges
Dieses Programm ist im Grunde nur die Demonstration einer HashMap Routine. Das einzige, auf das man Zugriff durch korrekte Eingabe erhält, ist die Lieblingsfarbe der generierten Nutzer.
